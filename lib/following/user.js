 ...
 */
function get(followingType, opts, tokens, cb) {
  ...
  var refreshTry = function () {
    apiToken.refresh.call(_this, refreshToken, function (err, accessToken) {
      ...
      _this.following.user(followingType, opts, accessToken, cb);
    });
  };
 ...
 * @param cb - callback(error, body, accessToken (new or current))
 */
function add(followingId, followingType, tokens, cb) {
  var
    _this = this,
    args = arguments.length;
  ...
  var refreshTry = function () {
    apiToken.refresh.call(_this, refreshToken, function (err, accessToken) {
      ...
      _this.following.user.add(followingId, followingType, accessToken, cb);
    });
  };
  // try refresh token function finish
 ...
 * @param cb - callback(error, body, accessToken (new or current))
 */
function remove(followingId, followingType, tokens, cb) {
  var
    _this = this,
    args = arguments.length;
  ...
  var refreshTry = function () {
    apiToken.refresh.call(_this, refreshToken, function (err, accessToken) {
      ...
      _this.following.user.delete(followingId, followingType, accessToken, cb);
    });
  };
  // try refresh token function finish
 ...
 * @param cb - callback(error, body, accessToken (new or current))
 */
function contains(followingId, followingType, tokens, cb) {
  var
    _this = this,
    args = arguments.length;
  ...
  var refreshTry = function () {
    apiToken.refresh.call(_this, refreshToken, function (err, accessToken) {
      ...
      _this.following.user.contains(followingId, followingType, accessToken, cb);
    });
  };
  // try refresh token function finish
